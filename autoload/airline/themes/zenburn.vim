...
let g:airline#themes#zenburn#palette.insert_modified = {
      \ 'airline_c': [ '#080808' , '#66d9ef' , 232 , 81 , '' ] ,
      \ }


" Replace mode
let g:airline#themes#zenburn#palette.replace = copy(g:airline#themes#zenburn#palette.insert)
let g:airline#themes#zenburn#palette.replace.airline_a = [ s:I1[0]   , '#ef5939' , s:I1[2] , 166     , ''     ]
let g:airline#themes#zenburn#palette.replace_modified = {
...
let g:airline#themes#zenburn#palette.visual_modified = {
...
let g:airline#themes#zenburn#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
